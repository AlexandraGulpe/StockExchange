...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfBuyers; i++){
            Thread buyerThread = new Thread(new Buyer(stockMarketSimulation, "AAPL", 100, 44.6, 1234, 0));
        ...
        for (int i = 0 ; i < numberOfSellers; i++){
            Thread sellerThread = new Thread(new Seller(stockMarketSimulation, "AAPL", 50, 44.6, 1234, 0));
